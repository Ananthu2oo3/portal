...
//       try {
//         const deliveryList = result['soap-env:Envelope']
//           ['soap-env:Body']
//           ['n0:ZDEL_CUST_AKG_FMResponse']
//           ['ET_DELIVERY_LIST']
//           ['item'];

//         const list = Array.isArray(deliveryList) ? deliveryList : [deliveryList];
...
//         res.status(500).json({
//           status: 'E',
//           message: 'Failed to extract delivery data from SOAP response'
//         });
//       }
//     });
